                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="menu_toevoeging" id="menu_toevoeging" value="{{ old('menu_toevoeging') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="beschrijving" id="beschrijving" rows="4"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('beschrijving') }}</textarea>
                                    @error('beschrijving')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
